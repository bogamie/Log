...
namespace Forensics_Tool.Utilities
{
    ...
    {
        public static void Extract(int selectedIndex, string selectedPath) {
            string targetDir;
            ...
            if (selectedIndex == 0) {
                ...
                bool success = ExtractRecursive(selectedPath, targetDir, isRoot: true);
                if (!success) {
        ...
        private static bool ExtractRecursive(string filePath, string destinationDir, bool isRoot)
        {
